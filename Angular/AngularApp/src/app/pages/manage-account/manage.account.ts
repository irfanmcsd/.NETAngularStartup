...
export class ManageAccountComponent implements OnInit, OnDestroy {
  ...
  headingTitle: string = 'Change Password';
  controls: any[] = [];
  ...
  private initializeUpdateControls(): void {
    this.controls = this.formService.ChangeUserPasswordControls(
  ...
  private handleSuccessfulSubmission(response: UserReponse): void {
    ...
    this.showNotification(`Password ${status} successfully!`, 'success');
